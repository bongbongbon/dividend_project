...
import com.sample.sample.scraper.Scraper;
...
public class CompanyService {
    ...
    private final Scraper yahoooFineneceScraper;
    ...
    private Company storeCompanyAndDividend(String ticker) {
        ...
        Company company = this.yahoooFineneceScraper.scrapCompanyByTicker(ticker);
        ...
        ScrapedResult scrapedResult = this.yahoooFineneceScraper.scrap(company);
